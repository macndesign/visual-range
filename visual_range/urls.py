...
from basic.views import BasicFormView, BasicAjaxFormView
...
urlpatterns = patterns('',
    ...
    url(r'^basic/', BasicAjaxFormView.as_view(), name='basic'),
    url(r'^basic-form/', BasicFormView.as_view(), name='basic-form'),
